...
- What drives customer satisfaction and frustration?
- How does sentiment evolve over time?
- Where should improvement efforts be prioritized?

This project answers all of those questions through a five-part, end-to-end analytics suite built on 30,000 real chatbot interactions spanning three and a half years.
...
This project follows a structured storytelling approach that moves from high-level business performance to detailed customer experience insights.

```text
1. Executive Performance Overview
              │
              ▼
2. Escalation & Resolution Analysis
              │
              ▼
3. Sentiment Performance Overview
              │
              ▼
4. Sentiment Trends & Interaction Patterns
              │
              ▼
5. Language & Query-Type Sentiment Deep Dive
```

Each stage builds upon previous findings, creating a complete picture of chatbot effectiveness.
...
- **French Feedback interactions**: maintained high sentiment even under escalated conditions
...
- Customer experience is **highly polarized**: ~25% very positive, ~25% very negative, only ~10% neutral
...
**Dimensions analyzed across all dashboards:**
- Chatbot version (v1.0, v1.1, v2.0, v2.1)
- Language (English, French, German, Spanish, Other)
- Query type (General, Technical Support, Product Inquiry, Feedback, Other)
...
Each dashboard was built with a clear principle: **executives need clarity, analysts need depth, and both need speed.**
...
## Some of Strategic Recommendations
...
## Navigate & Explore All Project Parts

| # | Part | Focus Area | Tableau Live Dashboard | Medium Story |
|---|------|-----------|---------------|---------|
| 1 | **AI Chatbot Interaction Data Exploring & Analysis Part 1 - Main Dashboard: Chatbot Executive Overview** | KPIs, engagement trends, resolution & satisfaction rates | [View Dashboard](https://public.tableau.com/views/AIChatbotInteractionDataExploringAnalysispart1-MainDashboard-ChatbotExecutiveOverview/MainDashboardChatbotExecutiveOverview?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link) | [Read on Medium](#) |
| 2 | **AI Chatbot Interaction Data Exploring & Analysis Part 2 - Story 1: Escalation and Resolution Patterns in Chatbot Interactions** | Where AI fails, escalation hotspots, unresolved interaction mapping | [View Dashboard](https://public.tableau.com/views/AIChatbotInteractionDataExploringAnalysispart2-Story1EscalationandResolutionPatternsinChatbotInteractions/Story1EscalationandResolutionPatternsinChatbotInteractions?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link) | [Read on Medium](#) |
| 3.1 | **AI Chatbot Interaction Data Exploring & Analysis part 3 - Story 2: A Deep Dive in Exploring Sentiment Patterns in Chatbot Conversations (1st Card)** | Language vs. version vs. query type sentiment analysis | [View Dashboard](https://public.tableau.com/views/AIChatbotInteractionDataExploringAnalysispart3-Story2-ADeepDiveinExploringSentimentPatternsinChatbotConversations/Story2ADeepDiveinExploringSentimentPatternsinChatbotConversations?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link) | [Read on Medium](#) |
| 3.2 | **AI Chatbot Interaction Data Exploring & Analysis part 3 - Story 2: A Deep Dive in Exploring Sentiment Patterns in Chatbot Conversations (2nd Card)** | Response length effectiveness, sentiment trends over time, polarization | [View Dashboard](https://public.tableau.com/shared/KHB9BHKB6?:display_count=n&:origin=viz_share_link) | [Read on Medium](#) |
| 3.3 | **AI Chatbot Interaction Data Exploring & Analysis part 3 - Story 2: A Deep Dive in Exploring Sentiment Patterns in Chatbot Conversations (3rd Card)** | Language × query type sentiment heatmaps, emotional hotspots | [View Dashboard](https://public.tableau.com/shared/WW4PYSS7K?:display_count=n&:origin=viz_share_link) | [Read on Medium](#) |
...
*Behind every metric is a conversation. Behind every conversation is a customer experience waiting to be understood.*
